...
export default class ProblemView extends Component {
    ...
    constructor(props){
        ...
        // this.htmlLatex = this.props.navigation.state.params.htmlLatex; //contains the latex
    ...
    render() {
        ...
        const htmlContent = 'c = \\pm\\sqrt{a^2 + b^2}'
        ...
        //               </style>
        //           </head>
        //           <body><h1>Let's hope this works</h1></body></html>`;
        const newHTML = `<!DOCTYPE html>
<html>
    <head>
